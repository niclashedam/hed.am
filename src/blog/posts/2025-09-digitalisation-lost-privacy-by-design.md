...
## Public Registers Are Not The Enemy — But They’re Not Harmless
...
**Open questions:** Why is CPR data available by default? Why can't the system be more granular in its protection or offer a data request flow, where users can choose who to share information with?
